...
?>
<div class="posts-list-item card doc-list-card">
    <a href="<?php the_permalink(); ?>" class="card-link">
        <div class="list-thumbnail">
            ...
            <?php else : ?>
                <div class="list-img placeholder-img">
        ...
        <div class="list-body">
            ...
            <?php if ($show_excerpt && has_excerpt()) : ?>
                <div class="item-excerpt"><?php echo esc_html(wp_trim_words(get_the_excerpt(), 60, '…')); ?></div>
            <?php endif; ?>
            <div class="item-meta">
